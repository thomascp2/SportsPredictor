...
- OAuth providers not configured (need Discord/Google/Apple credentials)
  Supabase callback URL: https://***REMOVED***/auth/v1/callback
...
4. Add redirect: `https://***REMOVED***/auth/v1/callback`
5. Run:
   ```bash
   curl -X PATCH \
...
3. Authorized redirect URIs: `https://***REMOVED***/auth/v1/callback`
...
```typescript
export const SUPABASE_URL = 'https://***REMOVED***';
