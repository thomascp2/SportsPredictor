...
class ContinuousFeatureExtractor:
    ...
    def __init__(self, db_path: str):
        ...
        self.opponent_extractor = OpponentFeatureExtractor(db_path)
    ...
    def connect(self):
        ...
        # Connect opponent extractor
        self.opponent_extractor.connect()
    ...
    def close(self):
        ...
        # Close opponent extractor
        self.opponent_extractor.close()
    ...
    def extract_features(self,
        ...
        # OPPONENT FEATURES (5 features) - NEW!
        opponent_features = self.opponent_extractor.extract_opponent_features(
            opponent_team=opponent,
            game_date=game_date,
            prop_type='shots'  # Note: 'shots' not 'points'
        )
